...
if($_SERVER['REQUEST_METHOD'] == 'POST'){
    ...
    $client->addReservation($ID_client, $ID_activite, $Date_reservation, $Status );
}
...
<body class="bg-gradient-to-b from-red-100 to-blue-500">
            ...
            <div class="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
                ...
                <div class="hidden justify-between items-center w-full lg:flex lg:w-auto lg:order-1 mt-[-4rem]" id="mobile-menu-2">
                    <ul class="flex flex-col mt-4 mr-[9rem] font-medium lg:flex-row lg:space-x-8 lg:mt-0">
                        ...
                        <li>
                            <a href="afficher_reservation.php" class="block py-2 pr-4 pl-3 text-gray-900 border-b border-gray-100 hover:bg-gray-50 lg:hover:bg-transparent lg:border-0 lg:hover:text-primary-700 lg:p-0 dark:text-gray-400 lg:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white lg:dark:hover:bg-transparent dark:border-gray-700">Réservations</a>
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <div id="frmrsrv" class="hidden fixed top-[6rem] left-[34rem] w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
            ...
            <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                ...
                <form class="max-w-sm mx-auto" method="POST">
                    ...
                    <input type="hidden" name="ID_activite" id="ID_activite" value="">
                ...
                <li class="mb-[3rem]"> 
                    <div class="w-[40rem] bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                        ...
                        <div class="p-5">
                            ...
                            <p class="mb-3 font-bold text-gray-700 dark:text-gray-400">Capacité: <?php echo htmlspecialchars($activity['Capacite_activite']); ?></p>
                           
                        </div>
                        <a id="frmbttn" onclick="getActiviteId(<?php echo $activity['ID']; ?>)" class="inline-flex mt-[1rem] mb-[1rem] ml-[33rem] items-center px-3 py-3 text-base font-medium text-center text-white bg-blue-900 rounded-lg hover:cursor-pointer" >Réserver</a>
                    </div>
                </li>
                <?php endforeach; ?>
        </ul>
    ...
    <script>
        function getActiviteId($id_activite){
            document.getElementById('ID_activite').value = $id_activite;
