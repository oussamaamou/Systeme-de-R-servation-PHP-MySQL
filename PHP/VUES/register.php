...
<body class="bg-gradient-to-b from-red-100 to-blue-500"> 
    ...
    <main class="mb-[8rem]">
        <h2 class="text-3xl mb-[2rem] text-center font-bold dark:text-white">Formulaire d'Inscription</h2>
        ...
        <button type="submit" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">S'Inscrire Maintenant</button>
        </form>
    </main>
